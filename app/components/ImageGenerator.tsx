...
import { Loader2, Image as ImageIcon, Key, ExternalLink, Download } from 'lucide-react';
...
const ImageGenerator: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      {generatedImage && (
        <div className="bg-white p-4 rounded-2xl shadow-xl border border-slate-100 animate-fade-in relative group">
          <div className="aspect-square w-full relative rounded-xl overflow-hidden bg-slate-100">
            ...
            <button
              ...
              className="absolute top-4 right-4 p-3 bg-white/90 hover:bg-white text-slate-800 rounded-xl shadow-lg opacity-0 group-hover:opacity-100 transition-all flex items-center gap-2"
